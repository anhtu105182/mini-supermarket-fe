<template>
  <div class="orders-page">
    <div class="orders-header">
      <!-- <h1 class="orders-title">Danh sách đơn trả hàng nhập</h1> -->
    ...
    <div class="orders-table">
      ...
      <EmptyState
        ...
        title="Tính năng chỉ hỗ trợ cho cửa hàng có nhiều chi nhánh quản lý kho"
        description="Vui lòng liên hệ Hotline: 1900 6750 mua thêm chi nhánh quản lý kho để sử dụng tính năng."
      >
        <!-- <template #actions>
          ...
          <button class="orders-add-btn">
            <i class="fa fa-plus-circle"></i> Tạo đơn trả hàng nhập
          </button>
        </template> -->
      </EmptyState>
    </div>
    <!-- <div class="orders-footer">
      Tìm hiểu về
      <a href="#" class="orders-link" style="margin-left: 5px"
        >đơn trả hàng nhập
      </a>
    </div> -->
  </div>
