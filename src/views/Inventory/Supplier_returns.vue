  ...
  <div class="orders-page">
    ...
    <div class="orders-table">
      ...
      <EmptyState
        ...
        title="Cửa hàng của bạn chưa có đơn trả hàng nhập nào"
        description="Tạo đơn trả hàng nhập từ nhà cung cấp để ghi nhận xuất kho trả hàng và nhận lại tiền hoàn"
      >
        <template #actions>
