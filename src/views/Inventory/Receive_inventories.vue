<template>
  <div class="orders-page">
    <div class="orders-header">
      <h1 class="orders-title">Danh sách đơn nhập hàng</h1>
    ...
    <div class="orders-table">
      ...
      <EmptyState
        ...
        title="Cửa hàng của bạn chưa có đơn nhập hàng nào"
        description="Tạo mới đơn nhập hàng để ghi nhận nhập kho tăng số lượng tồn cho sản phẩm"
      >
        <template #actions>
